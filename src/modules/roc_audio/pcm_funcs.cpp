...
size_t pcm_encode_samples(void* out_data,
    ...
    const packet::channel_mask_t inout_chan_mask = sample_spec.getChannels() | out_chan_mask;
...
size_t pcm_decode_samples(const void* in_data,
    ...
    const packet::channel_mask_t inout_chan_mask = in_chan_mask | sample_spec.getChannels();
